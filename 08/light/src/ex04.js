...
export default function example() {
	...
	// DirectionalLight : 태양광 같음
	const light = new THREE.DirectionalLight('white', 1, 100, 2);
	light.position.y = 3;
	scene.add(light);
	...
	// 크기가 크면 해상도가 높아지면서 그림자가 고화질이되지만 성능은 좀 떨어질 수 있음
	// default 값 = 512
